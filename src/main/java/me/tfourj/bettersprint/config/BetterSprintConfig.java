...
public class BetterSprintConfig {
    private static final Identifier ID = Identifier.of(Bettersprint.MOD_ID, "config");
    private static final Path CONFIG_PATH = FabricLoader.getInstance().getConfigDir().resolve("bettersprint.json5");

    public static final ConfigClassHandler<BetterSprintConfig> HANDLER = ConfigClassHandler.createBuilder(BetterSprintConfig.class)
            .id(ID)
    ...
    private static void clampHudValues() {
        ...
        if (config.indicatorScale < 0.5D) {
            config.indicatorScale = 0.5D;
        } else if (config.indicatorScale > 3.0D) {
            config.indicatorScale = 3.0D;
        }
    }
    ...
    public static Screen createScreen(Screen parent) {
        YetAnotherConfigLib configScreen = YetAnotherConfigLib.create(HANDLER, (defaults, config, builder) -> builder
                .title(Text.translatable("config.bettersprint.title"))
                .category(ConfigCategory.createBuilder()
                        .name(Text.translatable("config.bettersprint.category.general"))
                        .option(Option.<Boolean>createBuilder()
                                .name(Text.translatable("config.bettersprint.option.show_indicator"))
                                .description(OptionDescription.of(Text.translatable("config.bettersprint.option.show_indicator.desc")))
                                .binding(defaults.showIndicator, () -> config.showIndicator, value -> config.showIndicator = value)
                                .controller(BooleanControllerBuilder::create)
                                .build())
                        .option(Option.<Double>createBuilder()
                                .name(Text.translatable("config.bettersprint.option.indicator_x"))
                                .description(OptionDescription.of(Text.translatable("config.bettersprint.option.indicator_x.desc")))
                                ...
                                .controller(option -> DoubleSliderControllerBuilder.create(option)
                                        .range(0.0D, 1.0D)
                                        .step(0.01D)
                                        .formatValue(value -> Text.literal(String.format(Locale.ROOT, "%.0f%%", value * 100))))
                                .build())
                        .option(Option.<Double>createBuilder()
                                .name(Text.translatable("config.bettersprint.option.indicator_y"))
                                .description(OptionDescription.of(Text.translatable("config.bettersprint.option.indicator_y.desc")))
                                ...
                                .build())
                        .option(Option.<Double>createBuilder()
                                .name(Text.translatable("config.bettersprint.option.indicator_scale"))
                                .description(OptionDescription.of(Text.translatable("config.bettersprint.option.indicator_scale.desc")))
                                .binding(defaults.indicatorScale, () -> config.indicatorScale, value -> config.indicatorScale = clampScale(value))
                                .controller(option -> DoubleSliderControllerBuilder.create(option)
                                        .range(0.5D, 3.0D)
                                        .step(0.05D)
                                        .formatValue(value -> Text.literal(String.format(Locale.ROOT, "x%.2f", value))))
                                .build())
                        .option(Option.<Boolean>createBuilder()
                                .name(Text.translatable("config.bettersprint.option.indicator_shadow"))
                                .description(OptionDescription.of(Text.translatable("config.bettersprint.option.indicator_shadow.desc")))
                                .binding(defaults.indicatorShadow, () -> config.indicatorShadow, value -> config.indicatorShadow = value)
                                .controller(BooleanControllerBuilder::create)
                                .build())
                        .option(Option.<Boolean>createBuilder()
                                .name(Text.translatable("config.bettersprint.option.indicator_background"))
                                .description(OptionDescription.of(Text.translatable("config.bettersprint.option.indicator_background.desc")))
                                .binding(defaults.indicatorBackground, () -> config.indicatorBackground, value -> config.indicatorBackground = value)
                                .controller(BooleanControllerBuilder::create)
                                .build())
                        .option(Option.<Boolean>createBuilder()
                                .name(Text.translatable("config.bettersprint.option.indicator_border"))
                                .description(OptionDescription.of(Text.translatable("config.bettersprint.option.indicator_border.desc")))
                                .binding(defaults.indicatorBorder, () -> config.indicatorBorder, value -> config.indicatorBorder = value)
                                .controller(BooleanControllerBuilder::create)
                                .build())
                        .option(Option.<Boolean>createBuilder()
                                .name(Text.translatable("config.bettersprint.option.reduce_fov_jitter"))
                                .description(OptionDescription.of(Text.translatable("config.bettersprint.option.reduce_fov_jitter.desc")))
